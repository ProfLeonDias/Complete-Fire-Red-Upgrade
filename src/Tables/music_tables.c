...
{
	[CLASS_PKMN_TRAINER_1] = BGM_EYE_BOY,
	[CLASS_GAME_FREAK] = BGM_EYE_INTERVIEWERS_RS,
	[CLASS_JESSIE_AND] = BGM_EYE_CREEPY,
	[CLASS_PKMN_TRAINER_2] = BGM_EYE_BOY,
	[CLASS_INTERVIEWER] = BGM_EYE_INTERVIEWERS_RS,
	[CLASS_HEX_MANIAC] = BGM_EYE_CREEPY_RS,
	[CLASS_RICH_BOY] = BGM_EYE_SAILOR_RS,
	[CLASS_MASTER] = BGM_EYE_EXPERT_RS,
	[CLASS_GUITARIST_RS] = BGM_EYE_EXPERT_RS,
	[CLASS_KINDLER] = BGM_EYE_FAT_GUY_RS,
	[CLASS_BUG_MANIAC] = BGM_EYE_CREEPY_RS,
	[CLASS_SCHOOL_KID] = BGM_EYE_YOUNG_BOY_RS,
	[CLASS_SR_AND_JR] = BGM_EYE_GIRL_RS,
	[CLASS_POKEFAN] = BGM_EYE_SAILOR_RS,
	[CLASS_EXPERT] = BGM_EYE_EXPERT_RS,
	[CLASS_TRIATHLETE] = BGM_EYE_EXPERT_RS,
	[CLASS_DRAGON_TAMER] = BGM_EYE_ACE_TRAINER_RS,
	[CLASS_NINJA_BOY] = BGM_EYE_YOUNG_BOY_RS,
	[CLASS_BATTLE_GIRL] = BGM_EYE_EXPERT_RS,
	[CLASS_PARASOL_LADY] = BGM_EYE_SAILOR_RS,
	[CLASS_BOARDER] = BGM_EYE_FAT_GUY_RS,
	[CLASS_COLLECTOR] = BGM_EYE_CREEPY_RS,
	[CLASS_EXECUTIVE] = BGM_EYE_CREEPY,
	[CLASS_PKMN_TRAINER_3] = BGM_EYE_BOY,
	[CLASS_OLD_COUPLE] = BGM_EYE_EXPERT_RS,
	[CLASS_YOUNGSTER] = BGM_EYE_BOY,
	[CLASS_BUG_CATCHER] = BGM_EYE_BOY,
	[CLASS_LASS] = BGM_EYE_GIRL,
	[CLASS_SAILOR] = BGM_EYE_FAT_GUY_RS,
	[CLASS_CAMPER] = BGM_EYE_BOY,
	[CLASS_PICNICKER] = BGM_EYE_GIRL,
	[CLASS_POKEMANIAC] = BGM_EYE_CREEPY_RS,
	[CLASS_SUPER_NERD] = BGM_EYE_CREEPY_RS,
	[CLASS_HIKER] = BGM_EYE_FAT_GUY_RS,
	[CLASS_BIKER] = BGM_EYE_CREEPY_RS,
	[CLASS_BURGLAR] = BGM_EYE_CREEPY_RS,
	[CLASS_ENGINEER] = BGM_EYE_INTERVIEWERS_RS,
	[CLASS_FISHERMAN] = BGM_EYE_FAT_GUY_RS,
	[CLASS_SWIMMER_M] = BGM_EYE_SWIMMER_RS,
	[CLASS_CUE_BALL] = BGM_EYE_CREEPY_RS,
	[CLASS_GAMBLER] = BGM_EYE_INTERVIEWERS_RS,
	[CLASS_BEAUTY] = BGM_EYE_SAILOR_RS,
	[CLASS_SWIMMER_F] = BGM_EYE_SWIMMER_RS,
	[CLASS_PSYCHIC] = BGM_EYE_EXPERT_RS,
	[CLASS_ROCKER] = BGM_EYE_EXPERT_RS,
	[CLASS_JUGGLER] = BGM_EYE_INTERVIEWERS_RS,
	[CLASS_TAMER] = BGM_EYE_CREEPY_RS,
	[CLASS_BIRD_KEEPER] = BGM_EYE_SAILOR_RS,
	[CLASS_BLACK_BELT] = BGM_EYE_EXPERT_RS,
	[CLASS_RIVAL] = BGM_EYE_BOY,
	[CLASS_SCIENTIST] = BGM_EYE_CREEPY_RS,
	[CLASS_BOSS] = BGM_EYE_CREEPY,
	[CLASS_LEADER] = BGM_EYE_BOY,
	[CLASS_TEAM_ROCKET] = BGM_EYE_CREEPY,
	[CLASS_COOLTRAINER] = BGM_EYE_ACE_TRAINER_RS,
	[CLASS_ELITE_4] = BGM_EYE_ELITE_4_RS,
	[CLASS_GENTLEMAN] = BGM_EYE_SAILOR_RS,
	[CLASS_RIVAL_2] = BGM_EYE_BOY,
	[CLASS_CHAMPION] = BGM_EYE_CHAMPION_RS,
	[CLASS_CHANNELER] = BGM_EYE_CREEPY_RS,
	[CLASS_TWINS] = BGM_EYE_YOUNG_GIRL_RS,
	[CLASS_COOL_COUPLE] = BGM_EYE_ACE_TRAINER_RS,
	[CLASS_YOUNG_COUPLE] = BGM_EYE_YOUNG_GIRL_RS,
	[CLASS_CRUSH_KIN] = BGM_EYE_EXPERT_RS,
	[CLASS_SIS_AND_BRO] = BGM_EYE_SWIMMER_RS,
	[CLASS_PKMN_PROF] = BGM_EYE_BOY,
	[CLASS_PLAYER] = BGM_EYE_BOY,
	[CLASS_CRUSH_GIRL] = BGM_EYE_EXPERT_RS,
	[CLASS_TUBER] = BGM_EYE_YOUNG_BOY_RS,
	[CLASS_PKMN_BREEDER] = BGM_EYE_YOUNG_GIRL_RS,
	[CLASS_PKMN_RANGER] = BGM_EYE_FAT_GUY_RS,
	[CLASS_AROMA_LADY] = BGM_EYE_GIRL_RS,
	[CLASS_RUIN_MANIAC] = BGM_EYE_FAT_GUY_RS,
	[CLASS_LADY] = BGM_EYE_SAILOR_RS,
	[CLASS_PAINTER] = BGM_EYE_SAILOR_RS,
};
#endif
...
const u16 gClassBasedBattleBGM[NUM_TRAINER_CLASSES] =
{
	...
	[CLASS_ELITE_4] = BGM_BATTLE_RSE_ELITE_4,
	[CLASS_PKMN_TRAINER_2] = BGM_BATTLE_RED,
	[CLASS_JESSIE_AND] = BGM_BATTLE_TEAM_ROCKET,
	[CLASS_TEAM_ROCKET] = BGM_BATTLE_TEAM_ROCKET,
	[CLASS_EXECUTIVE] = BGM_BATTLE_TEAM_ROCKET,
	[CLASS_BOSS] = BGM_BATTLE_TEAM_ROCKET,
	[CLASS_PKMN_TRAINER_1] = BGM_BATTLE_RSE_RIVAL,
	[CLASS_GAME_FREAK] = BGM_BATTLE_RSE_CHAMPION,
};
...
const u16 gWildSpeciesBasedBattleBGM[] =
{
	...
	[SPECIES_HO_OH] = BGM_BATTLE_RSE_LEGENDARY,
	[SPECIES_LUGIA] = BGM_BATTLE_RSE_LEGENDARY,
	[SPECIES_CELEBI] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_LATIOS] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_LATIAS] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_GROUDON] = BGM_BATTLE_RSE_LEGENDARY,
	[SPECIES_KYOGRE] = BGM_BATTLE_RSE_LEGENDARY,
	[SPECIES_RAYQUAZA] = BGM_BATTLE_RSE_LEGENDARY,
	[SPECIES_JIRACHI] = BGM_BATTLE_LEGENDARY_BIRDS,
	[SPECIES_DEOXYS] = BGM_BATTLE_DEOXYS,
	[SPECIES_ARCEUS] = BGM_BATTLE_RSE_LEGENDARY,
};
...
const u16 gRandomBattleMusicOptions[] =
{
	...
	BGM_BATTLE_DEOXYS,
	BGM_BATTLE_RSE_TRAINER,
	BGM_BATTLE_FRONTIER_BRAIN,
	BGM_BATTLE_RSE_CHAMPION,
	BGM_BATTLE_RSE_REGI,
	BGM_BATTLE_RSE_LEGENDARY,
	BGM_BATTLE_RSE_RIVAL,
	BGM_BATTLE_RSE_TEAMS,
	BGM_BATTLE_RSE_ELITE_4,
	BGM_BATTLE_RSE_TEAM_LEADER,
	BGM_BATTLE_RSE_WILD,
	BGM_BATTLE_RED,
	BGM_BATTLE_TEAM_ROCKET,
};
