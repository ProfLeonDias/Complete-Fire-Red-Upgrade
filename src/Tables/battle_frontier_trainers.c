...
extern const u8 sTrainerName_[];
extern const u8 sTrainerName_May[];

extern const u8 sFrontierText__PreBattle[];
extern const u8 sFrontierText__PlayerWin[];
extern const u8 sFrontierText__PlayerLose[];
