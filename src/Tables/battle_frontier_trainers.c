...
extern const u8 sTrainerName_Anabel[];
extern const u8 sTrainerName_Brendan[];
extern const u8 sTrainerName_May[];
extern const u8 sTrainerName_Steven[];
extern const u8 sTrainerName_Wallace[];

extern const u8 sFrontierText_Anabel_PreBattle[];
extern const u8 sFrontierText_Anabel_PlayerWin[];
extern const u8 sFrontierText_Anabel_PlayerLose[];
...
extern const u8 sFrontierText_Steven_PreBattle[];
extern const u8 sFrontierText_Steven_PlayerWin[];
extern const u8 sFrontierText_Steven_PlayerLose[];

extern const u8 sFrontierText_Wallace_PreBattle[];
extern const u8 sFrontierText_Wallace_PlayerWin[];
extern const u8 sFrontierText_Wallace_PlayerLose[];
