...
static struct SmartWildMons sSmartWildAITable[] =
{
	...
	{SPECIES_GLASTRIER, AI_SCRIPT_CHECK_BAD_MOVE},
	{SPECIES_SPECTRIER, AI_SCRIPT_CHECK_BAD_MOVE},
	{SPECIES_CALYREX, AI_SCRIPT_CHECK_BAD_MOVE},
	{SPECIES_CALYREX_ICE, AI_SCRIPT_CHECK_BAD_MOVE},
	{SPECIES_CALYREX_GHOST, AI_SCRIPT_CHECK_BAD_MOVE},
	{0xFFFF, 0}
};
#endif
